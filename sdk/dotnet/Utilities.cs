...
namespace Pulumi.purga
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.purga.version.txt");
    ...
    internal sealed class purgaResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public purgaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
